...
bool CCoinsViewDB::GetUtxos(const std::string & address, std::set<CCoins> & coinset) {
    ...
    while (pcursor->Valid()) {
        ...
        try {
            ...
            if (chType == 'b') {
                ...
                // stakecoin related block index fields
