...
static const char *strMainNetDNSSeed[][2] = {
    {"seedstakecoin", "seed.stakecoin.net"},
    {"seed", "seed.stakecoin.net"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"tseedstakecoin", "tseed.stakecoin.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. stakecoin is probably already running."), addrBind.ToString().c_str());
        else
