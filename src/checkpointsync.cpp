...
// stakecoin: synchronized checkpoint (centrally broadcasted)
...
// stakecoin: get last synchronized checkpoint
...
// stakecoin: only descendant of current sync-checkpoint is allowed
...
// stakecoin: reset synchronized checkpoint to last hardened checkpoint
...
// stakecoin: find block wanted by given orphan block
...
// stakecoin: verify signature of sync-checkpoint message
...
// stakecoin: process synchronized checkpoint
...
// get information of sync-checkpoint (first introduced in stakecoin)
