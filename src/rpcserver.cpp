...
// stakecoin: remove transaction from mempool
...
// stakecoin: reserve balance from being staked for network protection
...
// stakecoin: check wallet integrity
...
void StopRPCThreads()
{
    ...
    rpc_io_service->stop();
    if (rpc_worker_group) rpc_worker_group->join_all();
